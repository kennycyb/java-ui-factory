...
public final class UiFactory {
    ...
    private ComponentContext createComponentFromDeclaredField(FactoryContext factoryContext,
    ...
    private void createFields(FactoryContext factoryContext, Object object,
        ...
        for (Field f : fields) {
            ...
            ComponentContext componentContext = createComponentFromDeclaredField(factoryContext,
                                                                                 container, object,
                                                                                 f);

            if (componentContext == null || componentContext.getComponent() == null) {
                continue;
            }

            if (layoutHandler
                    .handleComponent(container, componentContext.getEnclosedComponent(), f)) {
                ...
                if (LOGGER.isDebugEnabled()) {
                    LOGGER.debug("{} ({}) is not added", f.getName(), componentContext
    ...
    public <T extends JFrame> T createFrame(Class<T> frameClazz) {
        ...
        ComponentContext context = new ComponentContext(name == null ? "JFrame" : name.value());
    ...
    private <T extends Container> T createContainer(FactoryContext factoryInfo,
        ...
        ComponentContext context = new ComponentContext(containerClass.getName());
