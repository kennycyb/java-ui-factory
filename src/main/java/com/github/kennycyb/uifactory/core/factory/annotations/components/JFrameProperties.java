...
public @interface JFrameProperties {
	 ...
	 * @return
	 */
	WindowPosition windowPosition() default WindowPosition.DEFAULT;

	FrameCloseOperation frameCloseOperation() default FrameCloseOperation.NOTHING;

	String title() default "";

	/**
	 * Set the width of the JFrame
	 * 
	 * @return
	 */
	int width() default -1;
